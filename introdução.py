...
Limitações da solução: Nosso projeto possui algumas limitaçÕes que poderiam ser melhoradas, como uma representação mais realista do carro policial e dos bandidos. O pacman, por exemplo, poderia ter um formato mais similar a um carro de policial em vez do formato de um círculo.
